...
Gem::Specification.new do |spec|
  ...
  spec.description   = "jekyll-llms-txt is a Jekyll generator plugin that builds a standards-compliant llms.txt file from your site's posts, collections, and pages so AI language models can efficiently discover your content."
